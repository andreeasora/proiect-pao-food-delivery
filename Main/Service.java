...
public class Service
{
    ...
    public void setValue(@NotNull Order orderForSetValue)
    {
    ...
    public void showMenu(@NotNull Restaurant r)
    {
        System.out.println(r.getMenu());
    }

    public void showIngredients(@NotNull Product p)
    {
    ...
    public String searchProduct(@NotNull List<Order> orders)
    {
